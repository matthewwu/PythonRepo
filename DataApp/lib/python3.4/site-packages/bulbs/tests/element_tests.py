...
def suite():
    ...
    suite.addTest(Test.makeSuite(VertexProxyTestCase))
    suite.addTest(Test.makeSuite(VertexTestCase))
    suite.addTest(Test.makeSuite(EdgeProxyTestCase))
    # NOTE: there are no tests for the Edge because it doesn't have methods.

    return suite

if __name__ == '__main__':
    Test.main(defaultTest='suite')
