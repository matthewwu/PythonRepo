...
class Neo4jIndexTestCase(Test.TestCase):
...
class CypherTestCase(Test.TestCase):
...
def neo4j_client_suite():
    ...
    suite.addTest(Test.makeSuite(Neo4jClientTestCase))
    suite.addTest(Test.makeSuite(Neo4jClientIndexTestCase))
    suite.addTest(Test.makeSuite(Neo4jIndexTestCase))
    #suite.addTest(unittest.makeSuite(GremlinTestCase))
    #suite.addTest(unittest.makeSuite(CypherTestCase))
    return suite

if __name__ == '__main__':
    Test.main(defaultTest='neo4j_client_suite')
