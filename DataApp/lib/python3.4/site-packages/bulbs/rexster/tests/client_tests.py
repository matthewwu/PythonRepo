...
class RexsterAutomaticIndexTestCase(Test.TestCase):
...
def rexster_client_suite():
    ...
    suite.addTest(Test.makeSuite(RexsterClientTestCase))
    suite.addTest(Test.makeSuite(RexsterClientIndexTestCase))
    return suite
...
if __name__ == '__main__':
    ...
    Test.main(defaultTest='rexster_client_suite')
